...
@section('content')
   ...
   <script type="text/html" id="j-toolbar">
      <div class="layui-btn-container">
         <a class="layui-btn layui-btn-sm" href="/backend/register_user/register_user/create">新增</a>
      </div>
   </script>
...
@section('js')
   <script>
      var isAllow = {!! json_encode(\App\Model\RegisterUser::$isAllow) !!};
         ...
         var tableIns = table.render({
            ...
            ,cols: [[
               ...
               ,{fixed: 'right', title:'操作', width:150, templet:function (data) {
                  var btn = '';
                  btn += '<a class="layui-btn layui-btn-sm" href="/backend/register_user/register_user/edit?id='+data['id']+'">编辑</a>';
                  return btn;
               }}
            ]]
         });
